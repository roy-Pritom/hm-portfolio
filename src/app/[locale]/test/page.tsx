...
export default function SupplierRisk() {
  return (
    <div className="relative w-full min-h-screen bg-[#F2F8F9] pt-16 sm:pt-20 overflow-hidden">
      {/* Main curved background */}
      <div 
        className="absolute top-0 right-0 w-[150%] sm:w-[120%] md:w-[100%] lg:w-[60%] h-[60%] sm:h-[70%] md:h-[70%] lg:h-full bg-[#06445c] rounded-bl-[100%] transform origin-top-right scale-110 sm:scale-100"
      />
      ...
      <div className="relative  w-full pt-8 sm:pt-12 lg:pt-24 container mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12  items-center">
          ...
          <div className="space-y-4 sm:space-y-6 z-10 order-2 lg:order-1">
            <p className="text-sm font-semibold tracking-wider text-gray-900">SOLUTION</p>
